...
| 业务方案交接包 | 将 Plan、方案决策和业务边界与规则设计以版本、digest、证据和研发待决问题清单封装，交给下游研发团队的交付资产。 | — | 不直接指定技术模型、API、数据库或代码；模板见 `.template-spec/templates/strategic-design-handoff-template.yaml`。 |
